...
// Each function below renders one detail section of the HARTI analysis -
// split out (rather than one monolithic block) so the live HARTI Market
// Intelligence page can wrap each in its own collapsible, anchored container
// (opened by clicking its matching dashboard summary card), while a saved
// Weekly Report snapshot can still render all of them concatenated via the
// default AnalysisView export below.

export function MarketTrendSection({ analysis, marketSummarySubtitle }: { analysis: HartiAnalysis; marketSummarySubtitle: string }) {
...
export function PlantationComparisonSection({ analysis }: { analysis: HartiAnalysis }) {
...
export function TunnelHealthSection({ analysis }: { analysis: HartiAnalysis }) {
...
export function RecommendationsSection({ analysis }: { analysis: HartiAnalysis }) {
...
export function ActionItemsSection({ analysis }: { analysis: HartiAnalysis }) {
...
export function RiskAlertsSection({ analysis }: { analysis: HartiAnalysis }) {
...
// Full concatenated report (all sections, no collapsing) - used to render a
// saved Weekly Report snapshot in one shot.
export function AnalysisView({
  ...
  return (
    <>
      <MarketTrendSection analysis={analysis} marketSummarySubtitle={marketSummarySubtitle} />
